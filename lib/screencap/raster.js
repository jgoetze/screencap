...
// - renderWait    [optional] - default 0 - the time to wait after everything done before render
// - userAgent     [optional] - default null - set the user agent to be send while page call
...
function pickupNamedArguments() {
    ...
    if(args.renderWait)    { renderWait = args.renderWait; }
    if(args.userAgent)     { renderWait = args.userAgent; }
}
...
function takeScreenshot() {
   age.settings.userAgent = args.userAgent;
